...
host-pass-no-longer-host = Kamu telah menyerahkan status host ke pemain lain. Kamu tidak lagi menjadi host dari meja ini.
...
presence-status-playing = Bermain { $game }
presence-status-spectating = Menonton { $game }
presence-status-watching-table = Mengamati meja { $game }
